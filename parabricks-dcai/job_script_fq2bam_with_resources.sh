#!/bin/bash
#SBATCH --job-name=NA128XX-fq2bam
...
pbrun fq2bam \
    ...
    --knownSites /path/to/project/data/GATKBundle/Mills_and_1000G_gold_standard.indels.hg38.vcf.gz \
    --knownSites /path/to/project/data/GATKBundle/Homo_sapiens_assembly38.known_indels.vcf.gz \
    --knownSites /path/to/project/data/GATKBundle/Homo_sapiens_assembly38.dbsnp138.vcf.gz \
    --knownSites /path/to/project/data/GATKBundle/1000G_phase1.snps.high_confidence.hg38.vcf.gz \
    --out-recal-file NA128XX_2XXX.v4.2.4.grc38.pb.fq2bam.BQSR-report.txt \
